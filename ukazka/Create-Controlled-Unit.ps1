...
{
   Push-Location ".\src\ukazka-xae\ukazkaPlc\Technology"
   ...
   Add-Cu-Folder $name ((Get-Item ".\..\ukazkaPlc.plcproj").FullName)
   Link-Files-With-Project $name ((Get-Item ".\..\ukazkaPlc.plcproj").FullName)
   Pop-Location
}
